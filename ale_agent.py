...
class NeuralAgent(object):
    ...
    def start_episode(self, observation):
        ...
        # Marta
        self.episode_training_reward = 0
    ...
    def step(self, reward, observation):
        ...
        if self.testing:
            ...
            epsi = 0.1  # .05
            action = self._choose_action(self.test_data_set, epsi,
                                         observation, np.clip(reward, -1, 1))

        #NOT TESTING---------------------------
        else:
            self.episode_training_reward += reward
    ...
    def end_episode(self, reward, terminal=True):
        ...
        # Marta
        return np.mean(self.loss_averages)


    def finish_epoch(self, epoch):
        print('Not saving here')
